      ...
      <div className="flex items-center gap-3">
        <div className="relative hidden sm:block">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="pl-9 pr-4 py-1.5 text-sm border border-gray-200 rounded-lg bg-gray-50 text-slate-700 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent w-48"
          />
        </div>
        <button className="relative p-2 rounded-lg text-slate-500 hover:bg-gray-100 transition-colors">
